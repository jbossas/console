 ...
 * @date 5/18/11
 */
public class DeleteJvmCmd extends AddressableModelCmd implements AsyncCommand<Boolean>{

    public DeleteJvmCmd(DispatchAsync dispatcher, BeanFactory factory, ModelNode address) {
        ...
        dispatcher.execute(new DMRAction(operation), new AsyncCallback<DMRResponse>() {
            ...
            public void onSuccess(DMRResponse result) {
                ...
                if(success)
                    ...
                    Console.error("Failed: remove Jvm ");

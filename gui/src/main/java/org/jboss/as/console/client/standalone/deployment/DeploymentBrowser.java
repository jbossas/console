 ...
 * @date 11/22/2012
 */
public class DeploymentBrowser implements IsWidget
{
    ...
    {
        CustomTreeModel treeModel = new CustomTreeModel();
        cellBrowser = new CellBrowser.Builder(treeModel, null).pageSize(10).build();
        cellBrowser.setHeight("200px");
    }

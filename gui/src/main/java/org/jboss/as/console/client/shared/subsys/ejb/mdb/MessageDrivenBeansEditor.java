 ...
 */
public class MessageDrivenBeansEditor {
    private Form<MessageDrivenBeans> form;
    private final MessageDrivenBeansPresenter presenter;
    private ListBoxItem defaultPool;

    public MessageDrivenBeansEditor(MessageDrivenBeansPresenter presenter) {
    ...
    public Widget asWidget() {
        ...
        FormHelpPanel helpPanel = new FormHelpPanel(new FormHelpPanel.AddressCallback() {
            ...
            public ModelNode getAddress() {
                ...
                address.add(ModelDescriptionConstants.SUBSYSTEM, MessageDrivenBeansPresenter.SUBSYSTEM_NAME);
                return address;
            }
        }, form);

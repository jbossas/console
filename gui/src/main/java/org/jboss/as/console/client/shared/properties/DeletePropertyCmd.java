...
public class DeletePropertyCmd extends AddressableModelCmd implements AsyncCommand<Boolean>{
    ...
    public DeletePropertyCmd(DispatchAsync dispatcher, BeanFactory factory, ModelNode address) {
        super(dispatcher, factory, address);
    }

    @Override
    public void execute(AsyncCallback<Boolean> booleanAsyncCallback) {
        ...
        dispatcher.execute(new DMRAction(operation), new AsyncCallback<DMRResponse>() {
            ...
            public void onSuccess(DMRResponse result) {
                ...
                if(success)
                    ...
                    Console.error(Console.MESSAGES.deletionFailed("Property " + prop.getKey()), response.getFailureDescription());

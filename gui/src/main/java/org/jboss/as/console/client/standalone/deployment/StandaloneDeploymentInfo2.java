 ...
 */
public class StandaloneDeploymentInfo2 implements DeploymentViewRefresher {

  private DeploymentBrowserPresenter presenter;
  private DeploymentStore deploymentStore;
  private List<DeploymentRecord> allDeployments = Collections.EMPTY_LIST;

    public StandaloneDeploymentInfo2(final DeploymentBrowserPresenter deploymentBrowserPresenter,

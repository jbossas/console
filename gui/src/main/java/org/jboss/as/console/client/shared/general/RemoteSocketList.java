...
public class RemoteSocketList {
    ...
    Widget asWidget() {
        ...
        tools.addToolButtonRight(
                new ToolButton(Console.CONSTANTS.common_label_remove(), new ClickHandler() {
                    ...
                    public void onClick(ClickEvent clickEvent) {
                        ...
                        Feedback.confirm(
                                Console.MESSAGES.deleteTitle("RemoteSocketBinding"),
                                Console.MESSAGES.deleteConfirm("RemoteSocketBinding " + getSelectedEntity().getName()),
        ...
        MultipleToOneLayout layout = new MultipleToOneLayout()
                ...
                .setMaster("RemoteSocketBindings", factoryTable)

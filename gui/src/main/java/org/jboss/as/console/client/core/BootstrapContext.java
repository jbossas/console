...
public class BootstrapContext implements ApplicationProperties {
    ...
    public BootstrapContext() {
        ...
        */
        ...
        String domainApi = GWT.isScript() ? getBaseUrl()+"management" : "http://192.168.2.126:8888/app/proxy";
        setProperty(DOMAIN_API, domainApi);


        String deploymentApi = GWT.isScript() ? getBaseUrl()+"management/add-content" : "http://192.168.2.126:8888/app/upload";

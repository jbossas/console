...
public class BootstrapContext implements ApplicationProperties {
    ...
    public BootstrapContext() {
        ...
        String domainApi = GWT.isScript() ? getBaseUrl()+"domain-api" : "http://192.168.0.11:8888/app/proxy"; //"http://localhost:9990/domain-api";
        setProperty(DOMAIN_API, domainApi);


        String deploymentApi = GWT.isScript() ? getBaseUrl()+"domain-api/add-content" : "http://192.168.0.11:8888/app/upload";
